...
class Router implements RegistrarContract, BindingRegistrar
{
    ...
    public function auth()
    {
        ...
        $this->get('passwords/reset', 'Auth\ForgotPasswordController@showLinkRequestForm')->name('password.request');
        $this->post('passwords/email', 'Auth\ForgotPasswordController@sendResetLinkEmail')->name('password.email');
        $this->get('passwords/reset/{token}', 'Auth\ResetPasswordController@showResetForm')->name('password.reset');
        $this->post('passwords/reset', 'Auth\ResetPasswordController@reset');
    }
