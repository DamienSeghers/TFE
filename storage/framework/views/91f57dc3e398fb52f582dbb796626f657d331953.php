                ...
                <div class="col-md-8 core-login">
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('login')); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <a href="<?php echo e(route('password.request')); ?>" id="forgot" class="text-primary forgot1  pull-right"> Forgot Password? </a>
                        </div>
                        <div class="form-group ">
                            <button type="submit"  class="btn btn-primary login-btn">Login</button>
                            <br>
                            <hr>
                            <span> No account ?<a href="<?php echo e(route('register')); ?>"> Sign Up</a></span>
                        </div>
                    </form>
                </div>
                <div class="col-md-4">
                    <div class="social-buttons">
                        <p class="text-center">
                            <label>Seghers Damien</label>
                        </p>
                        <p class="text-center">
                             <label>3TL2</label>
                        </p>
                        <p class="text-center">
                            <label>TFE 2017</label>
                        </p>
                    </div>
                </div>
            </div>
