...
<?php $__env->startSection('header_styles'); ?>
    <!--page level css -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/vendors/bootstrap-table/css/bootstrap-table.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/custom_css/bootstrap_tables.css')); ?>">
...
<?php $__env->startSection('footer_scripts'); ?>
    ...
    <script type="text/javascript" src="<?php echo e(asset('assets/vendors/editable-table/js/mindmup-editabletable.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/vendors/bootstrap-table/js/bootstrap-table.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/vendors/tableExport/tableExport.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/custom_js/bootstrap_tables.js')); ?>"></script>
