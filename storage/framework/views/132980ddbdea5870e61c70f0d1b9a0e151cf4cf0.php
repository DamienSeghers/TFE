            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-sm-6 col-xs-12">
                    <div class="panel panel-widget">
                        ...
                        <div class="panel-body">
                            <ul class="basic-list">
                                <li><img src="<?php echo e(asset('assets/img/chrome.png')); ?>" alt="chrome">Google Chrome
                                    <span class="right label label-success pull-right">42.8%</span></li>
                                <li><img src="<?php echo e(asset('assets/img/firefox.png')); ?>" alt="firefox">Firefox
                                    <span class="right label label-danger pull-right">16.9%</span></li>
                                <li><img src="<?php echo e(asset('assets/img/safari.png')); ?>" alt="safari">Safari
                                    <span class="right label label-primary pull-right">15.5%</span></li>
                                <li><img src="<?php echo e(asset('assets/img/opera.png')); ?>" alt="opera">Opera
                                    <span class="right label label-info pull-right">11.8%</span></li>
                                <li><img src="<?php echo e(asset('assets/img/Ie.png')); ?>" alt="Internet Explorer">Internet Explorer
                                    <span class="right label label-danger pull-right">3.2%</span></li>
                                <li><img src="<?php echo e(asset('assets/img/mobile.png')); ?>" alt="mobile">Mobile
